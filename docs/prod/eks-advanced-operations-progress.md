...
| Discord 알림 연동 | `k8s/platform/observability/base/alertmanager-discord-config.yaml` | ✅ (코드 완료) | AlertmanagerConfig + ExternalSecret 모두 kustomization active. AWS Secrets Manager에 `utterai-prod/alertmanager-discord` 수동 등록 1회 필요 🖱️ |
